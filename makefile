...
source5  = source/constants_mod.f90 source/vector_mod.f90 source/common_mod.f90 source/interpolation_mod.f90 \
	source/set_input_mod.f90 source/hydro_mod.f90 source/ph_mod.f90 source/composition_mod.f90 \
	source/continuum_mod.f90 source/ionization_mod.f90 source/pathIntegration_mod.f90 \
	source/grid_mod.f90 source/dust_mod.f90 source/emission_mod.f90  source/photon_mod.f90  \
	source/update_mod.f90 \
	source/output_mod.f90 source/iteration_mod.f90 source/mocassinFluorescence.f90 

F90  = /home/rwesson/temp/mpi_g4.7/bin/mpif90
LIBS =	-lm
OPT1 = -O2
OPT2 = -CB -g 
...
mocassinFluorescence:
	$(F90) $(OPT1) -o mocassinFluorescence $(source5) $(LIBS) 

clean:
	/bin/rm *.o *~ *.mod mocassin mocassinWarm mocassinOutput mocassinPlot mocassinFluorescence
