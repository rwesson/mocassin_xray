...
module continuum_mod
    ...
    subroutine setContinuum()
           ...
           if (err /= 0) then
              ...
              case ('rauch')
                 ...
                 do i = 1, nbins
                    ...
                    if (  nuArray(i)>=enArray(1) .and. &
                         & nuArray(i)<=enArray(numLam)) then
                       call locate(enArray(1:numLam), nuArray(i), enP)
                       if (enP<numLam) then
                          inSpectrumErg(i) = 10.**( &
       ...
       if (allocated(lstar)) then
         print*, 'allocated!!'
         print*, lstar
       end if

       if (.not.allocated(lstar)) print*, 'NOT allocated!!'
    ...
    function getFlux(energy, temperature, cShape)
        ...
        case ("blackbody")
         ...
         case ("powerlaw")
            ...
            getFlux = (energy**(-pwlIndex))*exp(-energy/pwlMax)*exp(-pwlMin/energy)
