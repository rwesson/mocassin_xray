...
module constants_mod
    ...
    real, parameter :: FeL1 = 58.2353              !
    real, parameter :: FeL2 = 51.8382              !
    real, parameter :: CKa  = 20.3676              !
    real, parameter :: NKa  = 28.8529              !
    real, parameter :: OKa  = 38.5956              !
    real, parameter :: NeKa = 62.3971              !
    real, parameter :: MgKa = 92.1765              !
    real, parameter :: AlKa = 109.287              !
    real, parameter :: SiKa = 127.904              !
    real, parameter :: SKa  = 169.632              !
    real, parameter :: ArKa = 217.397              !
    real, parameter :: CaKa = 271.324              !
    real, parameter :: TiKa = 549.860              !
    ...
    integer, parameter :: nForLevels = 30           ! number of levels
